...
export default function Header() {
  ...
  return (
    <header className="bg-gray-900 sm:flex sm:items-center sm:justify-between xl:bg-white">
      ...
      <nav
        className={`sm:flex sm:items-center sm:px-4 xl:flex-1 xl:justify-between ${true ? 'hidden' : 'block'
          }`}
      >
        ...
        <div className="sm:flex sm:items-center">
          ...
          <div className="relative px-5 py-5 sm:py-0 sm:ml-4 sm:px-0">
            ...
            <div className="hidden sm:block">
              ...
              >
                <span
                  className={`block h-8 w-8 overflow-hidden rounded-full border-2 ${true || isOpen
              ...
              >
                <Link href="#account">
                  <a className="block hover:text-white text-gray-800 px-4 py-2 hover:bg-indigo-500">
                    Account settings
                  </a>
                </Link>
                <Link href="#support">
